...
variables = [
   ...
   f"{vaoi}_st.dev._of_fixation_durations_s",
   f"{vaoi}_min._fixation_duration_s",
   f"{vaoi}_max._fixation_duration_s",
   ...
   f"{vaoi}_min._saccade_duration",
   f"{vaoi}_max._saccade_duration",
